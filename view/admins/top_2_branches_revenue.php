...
<body>
    ...
    <section class="container bg-light p-4 my-3 border-bottom">        
        <div class="container my-5 py-3 bg-light-subtle">
            <h1 class="display-6 text-center">Top 2 sucursales que más dinero han ingresado</h1>
            ...
            <tbody>
                <?php if (isset($_SESSION['top_2_branches_revenue'])): ?>
                    <?php $res_a = $_SESSION['top_2_branches_revenue']; $i = 0; ?>
