...
<body>
    ...
    <section class="container bg-light p-4 my-3 border-bottom">        
        <div class="container my-5 py-3 bg-light-subtle">
            <h1 class="display-6 text-center">Top 10 ventas más grandes en un intervalo de tiempo</h1>
            ...
            <tbody>
                <?php if (isset($_SESSION['top_10_sales'])): ?>
                    <?php $res_a = $_SESSION['top_10_sales']; $i = 0; ?>
                    <?php foreach ($res_a as $res): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($res['cashier_name']); ?></td>
